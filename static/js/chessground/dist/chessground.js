var Chessground = (function () {
  ...
  const allKeys = Array.prototype.concat(
  ...
  const posToTranslateRel = (pos, asWhite) =>
  ...
  function canMove(state, orig, dest) {
    ...
    return (
      ...
      (state.movable.free ||
        !!((_b =
          (_a = state.movable.dests) === null || _a === void 0
            ? void 0
  ...
  function configure(state, config) {
    ...
    if ((_a = config.movable) === null || _a === void 0 ? void 0 : _a.dests)
      state.movable.dests = undefined;
    if (
      (_b = config.drawable) === null || _b === void 0 ? void 0 : _b.autoShapes
    )
  ...
  function start$1(s, e) {
    ...
    if (piece && element && stillSelected && isDraggable(s, orig)) {
      ...
      if (ghost) {
        ...
        translateAbs(
          ghost,
          posToTranslateAbs(bounds)(key2pos(orig), whitePov(s))
        );
  ...
  function render(s) {
    const asWhite = whitePov(s),
      posToTranslate = s.dom.relative
        ? posToTranslateRel
        : posToTranslateAbs(s.dom.bounds()),
